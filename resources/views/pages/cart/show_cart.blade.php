            ...
            <div class="row quantity-cart">
                <div class="col" style="padding-top: 5px;">
                    <form action="{{URL::to('/update-cart')}}" method="post">
                        @csrf
                        <input class="cart_quantity_input" type="number" min="1" name="cart_quantity" value="{{$value_content2->qty}}" autocomplete="off" size="2">
                        <input type="hidden" value="{{$value_content2->rowId}}" name="rowId_cart">
                        <button type="submit" value="Cập nhật" name="update_qty" style="display: none;"></button>
                    </form>
                </div>
            </div>
        </div>
